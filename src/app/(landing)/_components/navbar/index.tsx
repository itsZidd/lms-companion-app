            ...
            <div className="flex items-center gap-2">
                ...
                <SignedOut>
                    ...
                    >
                        ...
                        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-slate-700 px-2 py-1 font-mono font-medium text-slate-300 backdrop-blur-3xl">
                            Get Started
                        </span>
                    </Link>
                </SignedOut>
